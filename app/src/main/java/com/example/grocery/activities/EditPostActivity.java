...
public class EditPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadPostDetails(); //to set on views
        ...
        if (image_uri == null) {
            ...
            reference.child(postId).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        if (currentUserId.equals(postOwnerUid)) {
                            ...
                            mProgressDialog.dismiss();
                            Toast.makeText(EditPostActivity.this, "You are not the owner of this post. Cannot Edit Post Successfully.", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
                ...
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    ...
                    mProgressDialog.dismiss();
                    Toast.makeText(EditPostActivity.this, "" + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        } else {
            // Edit with an image
