...
public class AdapterProductSeller extends RecyclerView.Adapter<AdapterProductSeller.HolderProductSeller> implements Filterable {
    ...
    public ArrayList<ModelProduct> mProductList, mfilterList;
    ...
    public HolderProductSeller onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //inflate layout
        View view = LayoutInflater.from(mContext).inflate(R.layout.row_product_seller, parent, false);
    ...
    public void onBindViewHolder(@NonNull HolderProductSeller holder, int position) {
        //get data
        ModelProduct modelProduct = mProductList.get(position);
    ...
    private void detailsBottomSheet(ModelProduct modelProduct) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.bs_product_details_seller, null);
        ...
        deleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.setTitle("Delete")
                        .setMessage("Are you sure you want to delete this product " + title + " ?")
    ...
    public Filter getFilter() {
        //init filter
        if (filter==null) {
            filter = new FilterProduct(this, mfilterList);
        }
        return filter;
    }
